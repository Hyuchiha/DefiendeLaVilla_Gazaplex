 ...
 */
package com.hyuchiha.village_defense.Mobs.v1_12_R1.CustomMob.Boss;
...
public class SlimeBoss extends BossEnemy {
    ...
    public SlimeBoss(ConfigurationSection section) {
        super(CustomEntityType.CUSTOM_SLIME, section.getInt("min-gems"), section.getInt("max-gems"));
