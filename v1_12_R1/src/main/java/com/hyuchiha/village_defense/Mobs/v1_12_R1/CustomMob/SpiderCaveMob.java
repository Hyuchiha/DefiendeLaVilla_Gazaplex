...
public class SpiderCaveMob extends EnemyIA {
    ...
    public SpiderCaveMob(ConfigurationSection section) {
        super(CustomEntityType.CUSTOM_CAVESPIDER, section.getInt("difficulty"), section.getInt("min-gems"), section.getInt("max-gems"));
