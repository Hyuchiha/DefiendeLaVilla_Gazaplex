...
public class PigmanMob extends EnemyIA {
    ...
    public PigmanMob(ConfigurationSection section) {
        super(CustomEntityType.CUSTOM_PIGZOMBIE, section.getInt("difficulty"), section.getInt("min-gems"), section.getInt("max-gems"));
