...
public class Tank extends EnemyIA {
    ...
    public Tank(ConfigurationSection section) {
        super(CustomEntityType.CUSTOM_IRONGOLEM, section.getInt("difficulty"), section.getInt("min-gems"), section.getInt("max-gems"));
