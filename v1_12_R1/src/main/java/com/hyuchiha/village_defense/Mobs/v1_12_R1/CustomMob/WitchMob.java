...
public class WitchMob extends EnemyIA {
    ...
    public WitchMob(ConfigurationSection section) {
        super(CustomEntityType.CUSTOM_WITCH, section.getInt("difficulty"), section.getInt("min-gems"), section.getInt("max-gems"));
