...
public class SpiderMob extends EnemyIA {
    ...
    public SpiderMob(ConfigurationSection section) {
        super(CustomEntityType.CUSTOM_SPIDER, section.getInt("difficulty"), section.getInt("min-gems"), section.getInt("max-gems"));
