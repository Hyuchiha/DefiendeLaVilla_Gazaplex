 ...
 * @author hyuchiha
 */
public class WhiterSkullMob extends EnemyIA {
    
    public WhiterSkullMob(ConfigurationSection section) {
        super(CustomEntityType.CUSTOM_WITHER_SKELETON, section.getInt("difficulty"), section.getInt("min-gems"), section.getInt("max-gems"));
