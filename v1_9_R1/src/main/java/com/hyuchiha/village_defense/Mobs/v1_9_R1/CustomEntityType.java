 ...
 */
package com.hyuchiha.village_defense.Mobs.v1_9_R1;

import com.hyuchiha.village_defense.Mobs.EntityType;
import com.hyuchiha.village_defense.Mobs.MobUtils;
import com.hyuchiha.village_defense.Mobs.v1_9_R1.NMS.*;
...
public enum CustomEntityType implements EntityType {
    ...
    public void addToMaps(Class clazz, String name, int id) {
        ...
        ((Map) MobUtils.getPrivateField("f", net.minecraft.server.v1_9_R1.EntityTypes.class, null)).put(clazz, Integer.valueOf(id));
