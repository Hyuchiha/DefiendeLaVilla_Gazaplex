...
import com.hyuchiha.village_defense.Mobs.v1_15_R1.CustomEntityType;
...
public class MobCreator_v1_15_R1 implements MobCreator {
  ...
  public List<EnemyIA> createWaveMobs(ConfigurationSection config) {
    ...
    mobs.add(new WitherSkullMob(config.getConfigurationSection("WitherSkull"), CustomEntityType.CUSTOM_WITHER_SKELETON));
